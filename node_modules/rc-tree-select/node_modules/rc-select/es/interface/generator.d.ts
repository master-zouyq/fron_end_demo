...
export declare type GetLabeledValue<FOT extends FlattenOptionMapType> = (value: RawValueType, config: {
    optionMap: FOT;
...
export declare type FlattenOptionMapType<OptionType extends object = object> = Map<DefaultValueType, OptionType>;
