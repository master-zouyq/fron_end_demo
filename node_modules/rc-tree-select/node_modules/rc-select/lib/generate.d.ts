...
import { GetLabeledValue, FilterOptions, FilterFunc, DefaultValueType, RawValueType, LabelValueType, Key, FlattenOptionsType, SingleType, OnClear, SelectSource, CustomTagProps, FlattenOptionMapType } from './interface/generator';
...
export interface GenerateConfig<OptionsType extends object[]> {
    ...
    findValueOption: (values: RawValueType[], optionMap: FlattenOptionMapType<OptionsType[number]>) => OptionsType;
    /** Check if a value is disabled */
    isValueDisabled: (value: RawValueType, optionMap: FlattenOptionMapType<OptionsType[number]>) => boolean;
