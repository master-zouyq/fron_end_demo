...
export declare function findValueOption(values: RawValueType[], optionMap: Map<RawValueType, OptionData>): OptionData[];
export declare const getLabeledValue: GetLabeledValue<Map<RawValueType, OptionData>>;
...
export declare function isValueDisabled(value: RawValueType, optionMap: Map<RawValueType, OptionData>): boolean;
/**
