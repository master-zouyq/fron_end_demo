...
function findValueOption(values, optionMap) {
...
var getLabeledValue = function getLabeledValue(value, _ref) {
  ...
  var item = findValueOption([value], optionMap)[0];
  var result = {
    value: value
  };
  var prevValItem;
...
function isValueDisabled(value, optionMap) {
  var option = findValueOption([value], optionMap)[0];
...
function fillOptionsWithMissingValue(options, value, optionLabelProp, labelInValue) {
  ...
  values.forEach(function (item) {
    ...
    if (!optionValues.has(val)) {
      ...
      cloneOptions.push(labelInValue ? (_ref5 = {}, (0, _defineProperty2.default)(_ref5, optionLabelProp, item.label), (0, _defineProperty2.default)(_ref5, "value", val), _ref5) : {
        value: val
      });
    }
  });
